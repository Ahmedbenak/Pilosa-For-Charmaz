...
|---|---|---|
| `pilosa-charmaz-lecture` *(à créer)* | 1 — Segmentation | `00_Corpus_Source`, `01_Segments` |
| `pilosa-charmaz-codage-initial` | 2 — Codage initial | `02_Codage_Initial` |
| `pilosa-charmaz-codage-focalise` *(à créer)* | 3 — Codage focalisé | `03_Codage_Focalise` |
| `pilosa-charmaz-categorisation` | 4 — Catégorisation | `04_Categories` |
| `pilosa-charmaz-comparaison` *(à créer)* | 5 — Comparaison constante | `05_Comparaisons` |
| `pilosa-charmaz-memos` *(à créer)* | 6 — Mémos | `06_Memos` |
| `pilosa-charmaz-echantillonnage` *(à créer)* | 7 — Échantillonnage théorique | `07_Echantillonnage_Theorique` |
| `pilosa-charmaz-construction` *(à créer)* | 8-9 — Thèmes & Théorie | `08_Construction_Themes`, `09_Theorie_Finale` |
